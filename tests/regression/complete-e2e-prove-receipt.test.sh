...
assert isinstance(cases, list) and len(cases) >= 23, cases
...
print(
    ...
    "packed_artifact_sha256+packed_registry_integrity+registry_dist_extras+registry_dist_file_count+registry_metadata+registry_tarball_meta+registry_listing_meta+marketplace_api+marketplace_api_listing_meta+marketplace_vsix_download+marketplace_asset_heads+marketplace_listing_links+"
