...
assert isinstance(cases, list) and len(cases) >= 33, cases
...
print(
    ...
    "readme_media+consumer_complete_e2e+packed_cli_help+packed_cli_help_cluster+packed_dual_bin_version+packed_bin_payload+packed_media_walkthrough+packed_pkg_meta+packed_engine_enc+packed_media_marketplace_assets+"
