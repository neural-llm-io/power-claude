...
assert isinstance(cases, list) and len(cases) >= 15, cases
...
print(
    ...
    "packed_artifact_sha256+packed_registry_integrity+registry_metadata+marketplace_api+marketplace_vsix_download+marketplace_asset_heads+"
