...
assert isinstance(cases, list) and len(cases) >= 46, cases
...
print(
    ...
    "open_vsx_vsix_download+open_vsx_asset_heads+open_vsx_icon_integrity+open_vsx_download_count+open_vsx_listing_meta+product_site_links+pricing_page_links+product_pricing_site_bodies+package_json_version+packed_changelog_present"
)
PY
