...
assert isinstance(cases, list) and len(cases) >= 9, cases
...
print(
    ...
    "marketplace_api+marketplace_vsix_download+open_vsx_vsix_download+product_site_links+pricing_page_links"
)
PY
