...
assert isinstance(cases, list) and len(cases) >= 14, cases
...
print(
    ...
    "packed_artifact_sha256+registry_metadata+marketplace_api+marketplace_vsix_download+marketplace_asset_heads+"
