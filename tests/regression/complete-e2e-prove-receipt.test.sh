...
assert isinstance(cases, list) and len(cases) >= 31, cases
...
print(
    ...
    "readme_media+consumer_complete_e2e+packed_cli_help+packed_cli_help_cluster+packed_dual_bin_version+packed_bin_payload+packed_media_walkthrough+packed_pkg_meta+"
