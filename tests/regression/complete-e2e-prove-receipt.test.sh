...
assert isinstance(cases, list) and len(cases) >= 16, cases
...
print(
    ...
    "packed_artifact_sha256+packed_registry_integrity+registry_dist_extras+registry_metadata+marketplace_api+marketplace_vsix_download+marketplace_asset_heads+"
