...
def main():
    ...
    required = ["scripts/verify/run.sh", "scripts/verify/run.py", "scripts/complete-e2e/consumer.py", "scripts/complete-e2e/consumer.sh", "scripts/complete-e2e/check_readme_media.py", "scripts/complete-e2e/run.py", "scripts/complete-e2e/run.sh", "scripts/complete-e2e/prove.py", "scripts/complete-e2e/prove.sh", "scripts/complete-e2e/list-surfaces.py", "scripts/complete-e2e/execute-consumer.py", "scripts/complete-e2e/execute-consumer.sh", "configs/complete-e2e/runtime.json", "tests/regression/complete-e2e-prove-receipt.test.sh",
        "tests/regression/complete-e2e-help-documents-emergency-markers.test.sh", "tests/regression/complete-e2e-list-surfaces-no-attest.test.sh", "tests/regression/complete-e2e-execute-receipt.test.sh", "scripts/complete-e2e/clean-room-replay.py", "scripts/complete-e2e/clean-room-replay.sh", "tests/regression/complete-e2e-clean-room-replay.test.sh", "scripts/complete-e2e/check-adapter-paths.py", "scripts/complete-e2e/check-adapter-paths.sh", "scripts/complete-e2e/browser_product_prove.py", "scripts/complete-e2e/browser_product_prove.sh", "scripts/complete-e2e/browser_pricing_prove.py", "scripts/complete-e2e/browser_pricing_prove.sh", "scripts/complete-e2e/browser_openvsx_prove.py", "scripts/complete-e2e/browser_openvsx_prove.sh", "tests/regression/complete-e2e-adapter-paths.test.sh", "tests/regression/complete-e2e-browser-product-prove.test.sh", "tests/regression/complete-e2e-browser-pricing-prove.test.sh", "tests/regression/complete-e2e-browser-openvsx-prove.test.sh", "tests/regression/complete-e2e-httperror-not-env-block.test.sh", "tests/regression/enforce-runs-fail-closed-regressions.test.sh", "scripts/tidy/run.sh", "scripts/tidy/run.py", "tests/regression/tidy-leftover-receipts.test.sh", "tests/regression/release-ready-post-prove-receipt-purge.test.sh", "scripts/enforce/run.sh", "scripts/enforce/run.py", "scripts/release-ready/run.sh", "scripts/release-ready/run.py"]
    for rel in required:
