...
domain behavior.cases (packed_cli_help, packed_cli_help_cluster, packed_dual_bin_version, packed_bin_payload, packed_media_walkthrough, packed_pkg_meta, packed_engine_enc, packed_artifact_sha256, packed_registry_integrity, packed_prices_contract, packed_feature_matrix_stamps, packed_jq_platform_sha, registry_dist_extras, registry_dist_file_count,
