...
packed_dual_bin_version, packed_artifact_sha256, packed_registry_integrity, registry_dist_extras, registry_dist_file_count, registry_metadata, marketplace_api, marketplace_vsix_download,
marketplace_asset_heads, marketplace_listing_links, open_vsx_vsix_download, open_vsx_asset_heads, open_vsx_icon_integrity,
