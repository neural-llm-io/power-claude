...
open-vsx sha256 body + packed icon size integrity, packed extension.js+bin sha256, packed tarball sha1+file count vs registry, product/pricing site cross-links).
"""
